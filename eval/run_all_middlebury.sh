...
# H
#3-layer
python run_middlebury_H.py data/middlebury/trainingH ../build config_mb_cnn3.cfg data/parameters/middlebury/3-layer/cnn/ disp0CNN3
...
# # 7-layer
python run_middlebury_H.py data/middlebury/trainingH ../build config_mb_cnn7.cfg data/parameters/middlebury/7-layer/cnn/ disp0CNN7
